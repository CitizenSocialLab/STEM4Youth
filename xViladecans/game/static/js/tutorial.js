...
Tutorial.prototype = {
    ...
    show_slide: function(id) {
        ...
        if (this.current == 0) {
            ...
            $('#arrow_left').attr('src','/static/img/tutorial/blau/arrow_left_clara.png');
        } else {
            $('.prev-button').attr('disabled',false);
            $('#arrow_left').attr('src','/static/img/tutorial/blau/arrow_left.png');
        }
        if (this.current == this.count - 1) {
            $('.page_button_right').show();
            $('.next-button').attr('disabled',true);
            $('#arrow_right').attr('src','/static/img/tutorial/blau/arrow_right_clara.png');
        } else {
            $('.next-button').attr('disabled',false);
            $('#arrow_right').attr('src','/static/img/tutorial/blau/arrow_right.png');
        }
    },
